        ...
        public GpsPosition GetPosition(TimeSpan maxAge)
        {
            ...
            if (Opened)
            {
                ...
                if (result == 0)
                {
                    ...
                    //TODO Check valid fix / position, lat/lon 0 something like this:
                    if (
                        (gpsPosition.fixType == FixType.Unknown) ||
                        (gpsPosition.fixQuality == FixQuality.Unknown) ||
//                        (gpsPosition.flHorizontalDilutionOfPrecision > 50) ||
//                        (gpsPosition.flVerticalDilutionOfPrecision > 50) ||
                        (gpsPosition.dblLatitude == 0.0) ||
                        (gpsPosition.dblLongitude == 0.0) 
                        )
                        gpsPosition = null;                        
                }
