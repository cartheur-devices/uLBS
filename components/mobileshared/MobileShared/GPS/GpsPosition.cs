...
namespace MobileTracker.GPS
{
    ...
    public class GpsPosition
    {
        ...
        public double Latitude
        {
            get 
            {
                if (OpenNETCF.WindowsCE.DeviceManagement.OemInfo.ToLower().IndexOf("mio") >= 0)
                    return GetDegreesFromAngular(dblLatitude);
                else
                    return dblLatitude;
            }
        }

        private static double GetDegreesFromAngular(double dbl)
        {
            dbl /= 100;
        ...
        public double Longitude
        {
            ...
            {
                if (OpenNETCF.WindowsCE.DeviceManagement.OemInfo.ToLower().IndexOf("mio") >= 0)
                    return GetDegreesFromAngular(dblLongitude);
                else
                    return dblLongitude;
            }
        }
        ...
        public double DistLatLong(double lat1, double lon1, DistanceUnits units)
        {
